...
var ConnectionPage = /** @class */ (function () {
    function ConnectionPage(authenficationService, registerService, passwordService, alertCtl) {
        this.authenficationService = authenficationService;
        this.registerService = registerService;
        this.passwordService = passwordService;
        this.alertCtl = alertCtl;
    }
    ConnectionPage.prototype.login = function (email, password) {
        this.authenficationService.login(email, password);
        this.email = "";
        this.password = "";
    };
    ConnectionPage.prototype.registerUser = function (email, password) {
        var _this = this;
            ...
            buttons: [
                {
                    ...
                    handler: function (data) {
                        if (data.Email != null && data.Password != null) {
                            _this.registerService.register(email, password);
                        }
                    }
                },
                {
    ...
    ConnectionPage.prototype.motPasseOublie = function (email) {
        var _this = this;
        var alert = this.alertCtl.create({
            ...
            buttons: [
                {
                    ...
                    handler: function (data) {
                        if (data.email != null) {
                            _this.passwordService.forgotPassword(email);
                        }
                    }
                },
                {
